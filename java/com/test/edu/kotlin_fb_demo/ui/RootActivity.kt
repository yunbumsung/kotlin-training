...
open class RootActivity : AppCompatActivity() {
    ...
    fun showProgressDialog(msg: String = ".. 로딩 ..") {
        // mProgressDialog 객체가 널이면 생성 ProgressDialog(this) 아니면 그냥 사용 앨비스(?:)연산자
    ...
    override fun onBackPressed() {
        ...
        // 않떠있다. 백키 누르면 앱이 종료( super.onBackPressed())
        val flag = mProgressDialog?.isShowing ?: false
        if (flag)  hideProgressDialog()
